...
<body>
	...
	<form action="./regist_ok.jsp" method="post" name="regform"
		...
		<p>
			취미 : <label> 드라이브<input type="checkbox" name="hobby"
				value="드라이브" />
			</label> <label> 운동<input type="checkbox" name="hobby" value="운동" />
		...
		<p>
			주민등록번호 : <input type="text" name="ssn1" id="ssn1" maxlength="6"
				onkeyup="moveFocus()" onkeydown="ssnChange()" /> <input type="text"
				name="ssn2" id="ssn2" maxlength="7" onkeydown="ssnChange()" /> <input
				type="button" value="주민등록번호 검증" onclick="checkSsn()" />
		</p>
		<p>
			우편번호 : <input type="text" id="sample6_postcode" name="zipcode" /> <input
				type="button" onclick="sample6_execDaumPostcode()" value="우편번호 검색" />
		</p>
		<p>
			주소 : <input type="text" id="sample6_address" name="address1" /> 상세
			주소 : <input type="text" id="sample6_detailAddress" name="address2" />
		</p>
		<p>
			참고항목 : <input type="text" id="sample6_extraAddress" name="address3" />
		</p>
		<p>
